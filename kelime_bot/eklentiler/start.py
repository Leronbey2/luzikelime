...
keyboard = InlineKeyboardMarkup([
    [
        InlineKeyboardButton("➕ Grubuna Ekle", url=f"http://t.me/LuizKelimeevreni_bot?startgroup=new")
    ],
    [
        InlineKeyboardButton("🇹🇷 Sahibim", url="t.me/serserizarog"),
        InlineKeyboardButton("💬 Chat", url="t.me/SohbetmaxTR"),
    ]
])
